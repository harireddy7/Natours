        ...
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (resp.data.status === 'success') {
              (0, _alert.showAlert)('success', 'Logged in successfully!', 800);
...
var updateSettings = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(_ref) {
    var type, data, apiPath, resp;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            type = _ref.type, data = _ref.data;
            apiPath = type === 'password' ? 'auth/updatepassword' : 'users/updateme';
            _context.prev = 2;
            _context.next = 5;
            return (0, _axios.default)({
              method: 'PATCH',
              url: "/api/v1/".concat(apiPath),
              data: data
            });
          ...
          case 5:
            ...
            if (resp.data.status === 'success') {
              if (type === 'password') {
                (0, _alert.showAlert)('success', 'Password updated successfully!', 800); // RESET FORM FIELDS AFTER PASSWORD UPDATED
                ...
                (0, _alert.showAlert)('success', 'User data updated successfully!', 800);
                setTimeout(function () {
...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiaGFyaXJlZGR5NyIsImEiOiJja3U1bHlwdm8xd3ozMnVxZzAwNnp0NGk2In0.kNfWEkTwzfHM0aXRHClPIw';
  ...
  locations.forEach(function (loc) {
    ...
    new mapboxgl.Popup({
      offset: 30
    }).setLngLat(loc.coordinates).setHTML("<p>Day ".concat(loc.day, ": ").concat(loc.description, "</p>")).addTo(map); // Extend map bounds to include tour location
  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(tourId) {
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            stripe = Stripe('pk_test_51JjQQnSGRpo6XkVHFV3yxc0S6YxWqoLYiUsDzjmYpKPiLjbNL14TBqsjy4S0pJLTV8Unn1T0vgUfOejCiB93EJZo004PBXJkwR');
            _context.prev = 1;
            _context.next = 4;
...
var saveSettingsFormEl = document.querySelector('#save-settings');
var savePasswordFormEl = document.querySelector('#save-password');
var bookTourEl = document.querySelector('#book-tour'); // window.scroll({ top: 0, left: 0, behavior: 'smooth' });
// Get tour locations

if (mapEl) {
  var locations = mapEl ? JSON.parse(mapEl === null || mapEl === void 0 ? void 0 : mapEl.dataset.locations) : [];
...
if (saveSettingsFormEl) {
  saveSettingsFormEl.addEventListener('submit', function (e) {
    e.preventDefault();
...
if (savePasswordFormEl) {
  savePasswordFormEl.addEventListener('submit', function (e) {
    e.preventDefault(); // show btn progress

    document.getElementById('save-password-btn').textContent = 'Saving...'; // Form values
...
if (bookTourEl) {
  bookTourEl.addEventListener('click', function (e) {
    e.preventDefault(); // show btn progress

    var tourId = bookTourEl.dataset.tour_id;
...
if (logoutBtn) {
  logoutBtn.addEventListener('click', _login.logoutUser);
}
